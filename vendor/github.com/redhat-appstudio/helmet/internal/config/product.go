...
// BundleOutput documents an integration Secret bundle charts expose to dependents
// (name must look like tssc-<id>-integration). Not written to the merged cluster ConfigMap;
// type must be OutputTypeIntegrationSecret and values are validated against chart templates.
...
type Product struct {
	...
	// Outputs lists bundle-provided artifacts for dependents (see BundleOutput).
